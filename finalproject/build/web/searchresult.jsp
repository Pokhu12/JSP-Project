...
$(document).ready(function(){
	...
	<div class="container">
            <ul class="nav nav-pills">
				...
				<li><a  href="searchforbb.jsp?page=1"><h2>For Blood Bank</h2></a></li>
			</ul><br>
                                      ...
                                      int upper=lower;
                                                  ...
                                                  try {
                                                    ...
                                                    try{
                                                            ...
                                                            if(status1<=0)
                                                            {
                                                                %> <h2> Requested DONOR are not  Found!!</h2><br>
			...
			<div class="panel-body">
				<div class="row">
				<div class="col-md-12" style="margin-left: -5; margin-top:-5%;"><h4><img src="images/searchuser.jpg"  style="width:10%; margin-top:3%;">&nbsp;&nbsp;<%=rs.getString("Donorname")%></h4>
				<hr><span class="glyphicon glyphicon-calendar" style="font-size:85%; color:#a6a6a6;">&nbsp;last blood donated date : <%=rs.getString("donorq")%></span><br>
				<span class="glyphicon" style="font-size:85%; color:#a6a6a6;">&nbsp; Blood Group : </span><%=rs.getString("Donorbg")%>
				</div>
				</div>
			</div>	
			<div class="panel-footer" style ="background-color:#f3ffe6;">
						<div id="panel<%=pane%>" style=" margin-top :-10%; margin-bottom: -8%;color:#a6a6a6;" >
							<span class="glyphicon glyphicon-envelope" style="font-size:12px"></span>&nbsp;<%=rs.getString("Donoremail")%><br>
							<span class="glyphicon glyphicon-earphone"style="font-size:15px"></span>&nbsp;<%=rs.getString("Donorph")%><br>
							<i class="material-icons" style="font-size:15px">&#xe567;</i>&nbsp; <%=rs.getString("Donorcity")%>
						</div>
                  ...
                  int pg=Integer.parseInt(request.getParameter("page"));
                   for(int a=1;a<=total;a++)
                    ...
                    %>
                         ...
                         <a href="searchresult.jsp?page=<%=a%>" class="active"> <%=a%> </a>
                         <% }
                             else
                             {
                           %>      
                     <a href="searchresult.jsp?page=<%=a%>"> <%=a%> </a>
                    <% }
