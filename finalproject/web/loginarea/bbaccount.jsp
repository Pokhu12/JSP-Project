...
#panel,#panel1,#panel2,#panel3,#panel4,#panel5{
  ...
  <%    int status=0;
        ...
        try {
            con2 = DriverManager.getConnection("jdbc:oracle:thin:@Localhost:1521:xe","system" ,"65impokhu");
        } catch (SQLException ex) { }
        try
        {
            PreparedStatement preparestatement=con2.prepareStatement("select * from registerationbb where bbemail=?");
...
<%
        ...
        if(usernametype.equals("Blood Bank"))
        {
 ...
 %>
		...
		<!--end of data -->
						...
						<!--email name-->
                                                ...
                                                <div  class="col-md-9">
						 <%=rs.getString("bbname")%>&nbsp; <a id="flip"><span class="glyphicon glyphicon-pencil"></span>
                                                  </a>
                                                <div id="panel">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp" method="post">
												<input name= "bbname" type="text" class="form-control" placeholder="Enter Name Here.." >
												<br>
                ...
                try
                {
                      PreparedStatement p1=con.prepareStatement("select * from bbg where bbemail=?");
				...
				<div class="row">
						...
						<%=rs.getString("bbcity")%> &nbsp;<a id="flip4"><span class="glyphicon glyphicon-pencil"></span></a>
						<div id="panel4">
						<div class="form-group">
						<div class="col-md-12">
                                                <form action="changeprofile.jsp" method="post">
				...
				<div class="row">
						...
						<div class="col-md-9">
						<%=rs.getString("bbadd")%> &nbsp;<a id="flip5"><span class="glyphicon glyphicon-pencil"></span></a>
						<div id="panel5">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp" method="post">
