...
<%
    ...
    String cph=request.getParameter("cph");
       ...
       try {
        ...
        try{
                PreparedStatement p1=con.prepareStatement("insert into contact values(?,?,?,?,?)");
                p1.setString(1,cname);
                p1.setString(2,cemail);
                p1.setString(3,ccity);
                p1.setString(4,cph);
                p1.setString(5,cmsg);
...
<html>
  ...
  <h2 style="color:white; text-align: center;">Contact Us</h2>      
		...
		<div class="container">
				...
				<div class="tab-content">
					<div id="Donor" class="tab-pane fade in active">
								<form action="Lprocesscontact.jsp" method="post" onsubmit="return Validate()" name="vForm">
						<!--login details-->
							<div class="row">
								<div class="col-md-8 animate-box" >
									<div class="panel-group">
									<div class="panel panel-default">
									<div class="panel-heading"><h2>Get in touch</h2></div>
									<div class="panel-body">
					
										<div class="form-group form-group-lg">
											<div class="col-md-6"><br>
												 <label for="fname">Full Name*</label>
												<input name= "cname" type="text" id="fname" class="form-control" placeholder="Enter Name Here.." required>
											</div>
											<div class="col-md-6"><br>
												 <label for="lname">E-mail Id*</label>
												<input name= "cemail" type="email" id="lname" class="form-control" placeholder="Enter E-mail Id Here.." required>
											</div>
										</div>
    ...
    onchange="try{setCustomValidity('')}catch(e){}" class="form-control" placeholder="Enter Mobile Number Here.." name ="cph" required>
					</div>
											<div class="col-md-6"><br>
											
								 <label for="fname">City*</label><br>
											 <select name="ccity" id="blood" class="form-control" required>
						...
						<textarea id="message" cols="30" rows="10" class="form-control" placeholder="Give Your Feedback Here.." name="cmsg" required></textarea>
					</div>
										</div>
									</div>
								</div>
...
$(window).load(function(){        
   $('#myModal').modal('show');
	...
	var ccity = document.forms["vForm"]["ccity"];
