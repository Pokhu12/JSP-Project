...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js"></script>
	...
	<br>
  <h2 style="color:white; text-align: center;">Request For Blood</h2>      
</div>

		<div class="container">
                    <div class="row">
                        <div class="col-md-9">
			<form action="Lprocessrequestforblood.jsp" method="post" nsubmit="return Validate()" name="vForm">
			<div class="row">
				
				<div class="col-md-8 animate-box" ><br><br>
					...
					<div class="panel-heading"><h3>Patient Details</h3></div>
						...
						<div class="form-group-lg">
							<div class="col-md-6">
								...
								<input type="text" id="fname" name="pname" class="form-control" placeholder="Enter Name Here.." required>
							</div>
						...
						<div class="form-group-lg">
							<div class="col-md-12"><br>
								<label for="message">Hospital Name & Address*</label>
								<textarea name="hospital" id="message" cols="30" rows="10" class="form-control" placeholder="Enter Name & Address Here.." required></textarea>
							<br>
							</div>
							...
							<select name="requestbg" id="blood" class="form-control" required>
							...
							<select name="requestcity" id="blood" class="form-control" required>
							<option value="Select">Select </option>
					...
					<div class="panel-heading"><h3>Contact Details</h3></div>
						...
						<div class="form-group-lg">
							<div class="col-md-6">
								...
								<input type="email" id="lname" name= "requestemail" class="form-control" placeholder="Enter E-mail Id Here.." required>
							</div>
							<div class="col-md-6">
								 <label for="lname">Contact Number*</label>
								<input type="text" id="lname" Pattern = "[0-9]{10}" oninvalid="setCustomValidity('Plz enter on 10 digits phone number ')"
    onchange="try{setCustomValidity('')}catch(e){}" class="form-control" name="requestph" placeholder="Enter Contact Number Here.." required><br>
							</div>
							
							<div class="col-md-6">
								 <label for="lname">Date Of Blood Requirement*</label>
								<input type="date" name="requestdate" id="fname"  max="2042-12-31" min="2017-01-07" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
	   ...
	   <div>
										<label class="checkbox">&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="checkbox" value="accept" name="accept_terms" required/>
										<span style="color:#A49F9F;">I agree to have my contact details broadcasted to the registered donors of BloodBankIndia.net </label></span>
											<br>
												
						
		</div>
		<button class="btn btn-primary btn-lg" type =" submit"><big>Submit Request</big></button>
		<br>
		</form>	
		</div>
                        <br><br><br>
