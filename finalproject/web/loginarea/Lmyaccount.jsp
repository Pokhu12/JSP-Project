  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<body>
            <%
                ...
                {
                    response.sendRedirect("bbaccount.jsp");
                }
	...
	<br>
  <h2 style="color:white; text-align: center;">Welcome 
  <%    int status=0;
        ...
        try
        {
            PreparedStatement preparestatement=con1.prepareStatement("select * from registerationdonor where donoremail=?");
              preparestatement.setString(1, donoremail);
            ResultSet rs=null;
...
<%
        ...
        String userpassword =(String)session.getAttribute("sessionuserpassword");
        String usernametype=(String)session.getAttribute("sessionusertype");
        if(usernametype.equals("Donor"))
        {
 ...
 %>
		...
		<!--end of data -->
						...
						<!--email name-->
                                                ...
                                                <div  class="col-md-9">
						 <%=rs.getString("donorname")%>&nbsp; <a id="flip"><span class="glyphicon glyphicon-pencil"></span>
                                                  </a>
                                                <div id="panel">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp" method="post">
												<input name= "donorname" type="text" class="form-control" placeholder="Enter Name Here.." >
												<br>
				...
				<div class="row">
						...
						<div class="col-md-9">
						<%=rs.getInt("donorage")%> &nbsp;<a id="flip1"><span class="glyphicon glyphicon-pencil"></span></a>
						<div id="panel1">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp">
												<input name= "donorage" type="number" max=60 min=18  class="form-control" placeholder="Enter Age Here.." required>
												<br>
												<button class="btn btn-primary">Save & Change</button>
											</form>
											</div>
				...
				<div class="row">
						...
						<div class="col-md-9">
                                                    <%=rs.getInt("donorweight")%>
						&nbsp;<a id="flip2"><span class="glyphicon glyphicon-pencil"></span></a>
						<div id="panel2">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp" method="post">
												<input name= "donorweight" type="number" min=45 id="fname" class="form-control" placeholder="Enter Weight Here.." required>
												<br>
												<button class="btn btn-primary">Save & Change</button>
											</form>
											</div>
				...
				<div class="row">
						...
						<div class="col-md-9">
                                                    <%=rs.getString("donorph")%>
						&nbsp;<a id="flip3"><span class="glyphicon glyphicon-pencil"></span></a>
							<div id="panel3">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp" method="post">
												<input name= "donorph" type="number" pattern=[0-9]{10} class="form-control" placeholder="Enter phone number Here.." required>
												<br>
												<button class="btn btn-primary">Save & Change</button>
											</form>
											</div>
				...
				<div class="row">
						...
						<%=rs.getString("donorcity")%> &nbsp;<a id="flip4"><span class="glyphicon glyphicon-pencil"></span></a>
						<div id="panel4">
						<div class="form-group">
						<div class="col-md-12">
                                                <form action="changeprofile.jsp" method="post">
				...
				<div class="row">
						...
						<div class="col-md-9">
						<%=rs.getString("donoradd")%> &nbsp;<a id="flip5"><span class="glyphicon glyphicon-pencil"></span></a>
						<div id="panel5">
						<div class="form-group">
											<div class="col-md-12">
											<form action="changeprofile.jsp" method="post">
