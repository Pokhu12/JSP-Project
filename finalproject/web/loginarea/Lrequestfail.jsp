						...
						<div class="panel-group col-md-12">
							<div class="panel panel-default">
								  <div class="panel-body">
								   <span style="color : red;"><h1>Your Request is Failed!!<br>Email with same Blood Group is already exit</h1></span>
								  <br>
									<hr>
									<a href="Lrequestforblood.jsp" class="btn btn-primary btn-md btn-reg" style="margin-left:50%;">Request Again!</a>
								</div>
							</div>
