					...
					<div class="row animate-box">
						<div class="panel-group col-md-12">
							<div class="panel panel-default">
								  ...
								  <h1>Your Registration <span style="color : green;">is Failed!!<br>Email is already exit</span></h1>
								  <br>
									<hr>
									<a href="login.jsp" class="btn btn-primary btn-md btn-reg" style="margin-left:50%;">Login</a>
								</div>
							</div>
