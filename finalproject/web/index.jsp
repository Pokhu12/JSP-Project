			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				...
			   				<div class="slider-text-inner">
			   					<h1>Donate blood, donate life</h1>
									<h2><a href="registeration.jsp">Register </a> with us</h2>
									<p><a class="btn btn-primary btn-lg" href="searchform.jsp">Search For Blood</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
								...
								<h2><a href="registeration.jsp">Register </a>  with us</h2>
									<p><a class="btn btn-primary btn-lg btn-learn" href="searchform.jsp">Search For Blood</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
